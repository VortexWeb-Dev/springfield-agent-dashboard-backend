...
class RankingController extends BitrixController
{
    ...
    public function processRequest(string $method, ?string $id): void
    {
        ...
        $allDeals = $this->getDeals(['CLOSED' => 'Y'], ['ID', 'CLOSEDATE', 'UF_CRM_1727871937052', 'ASSIGNED_BY_ID']);
    ...
    private function calculateRankings(array $allDeals, array $deals, int $id): array
    {
        ...
        foreach ($deals as $deal) {
            ...
            $commission = isset($deal['UF_CRM_1727871937052']) ? (float)$deal['UF_CRM_1727871937052'] : 0;
